...
-- Custom Volume Bar to see the Volume
-- Volume Bar
...
-- {{{ Error handling
-- Check if awesme encountered an error during startup and fell back to
...
-- beautiful.font = "firacode"
beautiful.wallpaper = "/home/aberlanas/Imágenes/darkSpace.jpg"
